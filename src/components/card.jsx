...
import klambiImage from "../images/klambi.png"; // Import the image

const Projects = () => {
  const projects = [
    {
      imageSrc: klambiImage, // Use the imported image
    ...
    {
      imageSrc: "https://via.placeholder.com/445x269", // Placeholder image for another project
